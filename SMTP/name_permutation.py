...
$ python2 name_permutation.py -n 'urs polar'       # single name

$ python2 name_permutation.py -f 'users.txt'       # list of names
...
"""
Please specify an input file or name

usage: permutation.py [ -f <file> ] [ -n <full name> ] [ -l ]
